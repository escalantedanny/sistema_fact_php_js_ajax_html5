...
class modulo extends utilidad
{
	...
	{
		$sql="select * from modulo,opcion,permiso where cod_mod=fky_mod and cod_opc=fky_opc and est_per='A' and fky_usu=$usu order by fky_mod,nom_opc";
		$res=$this->ejecutar($sql);
		//$men=$this->extraer_dato($res);
		return $res;
	}
